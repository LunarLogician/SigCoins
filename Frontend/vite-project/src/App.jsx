                ...
                <div className="max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8 relative">
                  <div className="text-center">
                    ...
                    <p className="text-xl md:text-2xl mb-8 text-gray-300">
                         Earn money by playing games, watching ads, or mining. Start now and make up to $0.1 for 24 hours of mining!
                    </p>
              ...
              <section className="py-20 bg-zinc-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <FeatureCard
                      title="Watch Ads or Play Games"
                      description="Earn coins by watching targeted advertisements or playing games"
